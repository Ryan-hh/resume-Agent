...
export const DEFAULT_FIELD_ORDER: BasicFieldType[] = [
  ...
  { id: "3", key: "birthDate", label: "生日", type: "date", visible: true },
  { id: "4", key: "email", label: "邮箱", type: "text", visible: true },
  { id: "5", key: "phone", label: "电话", type: "text", visible: true },
  { id: "6", key: "location", label: "所在地", type: "text", visible: true },
];
